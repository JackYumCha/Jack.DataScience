...
namespace ArangoDB.Client
{
    ...
    public static class QueryableExtensions
    {
        ...
        [ExtentionIdentifier("Skip")]
        public static IQueryable<TSource> Skip<TSource>(this IQueryable<TSource> source, int offset)
        {
            return source.Provider.CreateQuery<TSource>(
                Expression.Call(
                    FindExtention("Skip", typeof(TSource)),
                    source.Expression,
                    Expression.Constant(offset)));
        }

        [ExtentionIdentifier("Take")]
        public static IQueryable<TSource> Take<TSource>(this IQueryable<TSource> source, int count)
        {
            return source.Provider.CreateQuery<TSource>(
                Expression.Call(
                    FindExtention("Take", typeof(TSource)),
                    source.Expression,
                    Expression.Constant(count)));
        }
